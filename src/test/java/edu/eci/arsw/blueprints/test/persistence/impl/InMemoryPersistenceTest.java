...
public class InMemoryPersistenceTest {
    ...
    @Test
    public void saveAndGetBlueprintTest() {
    ...
    @Test
    public void saveAndGetBlueprintTest2() {
        ApplicationContext ac = new ClassPathXmlApplicationContext("applicationContext.xml");
        BlueprintsServices bs = ac.getBean(BlueprintsServices.class);
     ...
     */
    //@Test
    public void filtroRedundanciaBlueprintTest() {
        ApplicationContext ac = new ClassPathXmlApplicationContext("applicationContext.xml");
        BlueprintsServices bs = ac.getBean(BlueprintsServices.class);
     ...
     */
    @Test
    public void filtroSubmuestreoBlueprintTest() {
        ApplicationContext ac = new ClassPathXmlApplicationContext("applicationContext.xml");
        BlueprintsServices bs = ac.getBean(BlueprintsServices.class);
        ...
        try {
            assertEquals(bs.getBlueprint("Josh", "Architec").getPoints().size(), 2);
            assertEquals(bs.getBlueprint("Clark", "MyFirstDraw").getPoints().size(), 3);
        } catch (BlueprintNotFoundException ex) {
            Logger.getLogger(InMemoryPersistenceTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
